      ...
      <main className="flex w-full max-w-[1440px] mx-auto flex-col gap-16 px-16 py-20">
        <div className="flex flex-col">
          <div className="flex flex-col gap-6">
            ...
            {/* Row 1 — tag */}
            <div className="tag self-start hero-reveal hero-reveal-1">
            ...
            <div className="flex flex-col gap-4 hero-reveal hero-reveal-3">
          ...
          {/* Row 3 — byline */}
          <p className="font-mono-m1 italic text-[var(--color-gray-300)] mt-[22px] hero-reveal hero-reveal-4">
